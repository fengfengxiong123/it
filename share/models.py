...
class Dot(models.Model):
    ...
    font = models.BooleanField(verbose_name='前端', blank=True, null=True, default=True)
    backend = models.BooleanField(verbose_name='后端', blank=True, null=True, default=True)
    server = models.BooleanField(verbose_name='服务器', blank=True, null=True, default=True)
    dev = models.BooleanField(verbose_name='开发', blank=True, null=True, default=True)
    product = models.BooleanField(verbose_name='部署', blank=True, null=True, default=True)
